...
public class SignInActivity extends BaseActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("vinod ",locationManager.toString());
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            try{
                sharedPreferencesUtil.setUserNameAndEmail(acct.getDisplayName(), acct.getEmail());
                Log.i("vinod ", sharedPreferencesUtil.getEmail() + " " + sharedPreferencesUtil.getUserName() + " " + acct.getEmail());
